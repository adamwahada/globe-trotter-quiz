...
export const translations = {
  en: {
    ...
    ruleStep4Title: 'First Letter Hint',
    ruleStep4Desc: 'Stuck? Reveal the first letter of the country name. Costs 1 point.',
    ruleStep5Title: 'Famous Person Hint',
    ruleStep5Desc: 'Get a hint by seeing a famous person from that country. Costs 1 point.',
    ruleStep6Title: 'Flag Hint',
    ruleStep6Desc: 'View the country flag for a visual clue. Costs 1 point AND takes 10 seconds off your timer!',

    // Hints Section
    hintsTitle: 'Need Help?',
    hintsSubtitle: 'If you feel stuck, you can use hints to help you guess the country',
    hintsIntro: 'Three types of hints are available during gameplay. Each hint costs 1 point, so use them wisely!',
    hintLetterName: 'First Letter',
    hintLetterInfo: 'Reveals the first letter of the country name. Costs 1 point.',
    hintPersonName: 'Famous Person',
    hintPersonInfo: 'Shows a famous personality from that country. Costs 1 point.',
    hintFlagName: 'Country Flag',
    hintFlagInfo: 'Displays the country flag. Costs 1 point AND 10 seconds off your timer!',
  ...
  fr: {
    ...
    ruleStep4Title: 'Indice Première Lettre',
    ruleStep4Desc: 'Bloqué ? Révélez la première lettre du nom du pays. Coûte 1 point.',
    ruleStep5Title: 'Indice Personnalité',
    ruleStep5Desc: 'Obtenez un indice en voyant une personnalité de ce pays. Coûte 1 point.',
    ruleStep6Title: 'Indice Drapeau',
    ruleStep6Desc: 'Voyez le drapeau du pays pour un indice visuel. Coûte 1 point ET enlève 10 secondes de votre temps !',

    // Hints Section
    hintsTitle: 'Besoin d\'Aide ?',
    hintsSubtitle: 'Si vous êtes bloqué, vous pouvez utiliser des indices pour vous aider à deviner le pays',
    hintsIntro: 'Trois types d\'indices sont disponibles pendant le jeu. Chaque indice coûte 1 point, utilisez-les judicieusement !',
    hintLetterName: 'Première Lettre',
    hintLetterInfo: 'Révèle la première lettre du nom du pays. Coûte 1 point.',
    hintPersonName: 'Personnalité',
    hintPersonInfo: 'Affiche une personnalité célèbre de ce pays. Coûte 1 point.',
    hintFlagName: 'Drapeau',
    hintFlagInfo: 'Affiche le drapeau du pays. Coûte 1 point ET 10 secondes de votre temps !',
  ...
  ar: {
    ...
    ruleStep4Title: 'تلميح الحرف الأول',
    ruleStep4Desc: 'عالق؟ اكشف الحرف الأول من اسم الدولة. يكلف نقطة واحدة.',
    ruleStep5Title: 'تلميح شخص مشهور',
    ruleStep5Desc: 'احصل على تلميح برؤية شخص مشهور من تلك الدولة. يكلف نقطة واحدة.',
    ruleStep6Title: 'تلميح العلم',
    ruleStep6Desc: 'شاهد علم الدولة كدليل بصري. يكلف نقطة واحدة و 10 ثوانٍ من وقتك!',

    // Hints Section
    hintsTitle: 'تحتاج مساعدة؟',
    hintsSubtitle: 'إذا شعرت بأنك عالق، يمكنك استخدام التلميحات لمساعدتك في تخمين الدولة',
    hintsIntro: 'ثلاثة أنواع من التلميحات متاحة أثناء اللعب. كل تلميح يكلف نقطة واحدة، استخدمها بحكمة!',
    hintLetterName: 'الحرف الأول',
    hintLetterInfo: 'يكشف الحرف الأول من اسم الدولة. يكلف نقطة واحدة.',
    hintPersonName: 'شخص مشهور',
    hintPersonInfo: 'يعرض شخصية مشهورة من تلك الدولة. يكلف نقطة واحدة.',
    hintFlagName: 'علم الدولة',
    hintFlagInfo: 'يعرض علم الدولة. يكلف نقطة واحدة و 10 ثوانٍ من وقتك!',
