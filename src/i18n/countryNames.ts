/**
 * Localized country names for all supported languages.
 * The English name is the canonical key used throughout the codebase.
 * Each language has its own set of names and aliases for matching.
 */
...
export interface LocalizedCountry {
  ...
  fr: string;
  ar: string;
  // Lowercase aliases for each language (for forgiving input matching)
  aliases?: {
    en?: string[];
    fr?: string[];
    ar?: string[];
 ...
 * Key is the canonical English name used in the game data.
 */
export const localizedCountryNames: Record<string, LocalizedCountry> = {
  ...
  'Guinea-Bissau': { 
    en: 'Guinea-Bissau', fr: 'Guinée-Bissau', ar: 'غينيا بيساو',
    aliases: { en: ['guinea bissau'], fr: ['guinee bissau', 'guinee-bissau'] }
  },
  'Ivory Coast': { 
    en: 'Ivory Coast', fr: "Côte d'Ivoire", ar: 'ساحل العاج',
    aliases: { en: ["cote d'ivoire", 'cote divoire'], fr: ['cote divoire'] }
  },
  ...
  'Bosnia and Herzegovina': { 
    en: 'Bosnia and Herzegovina', fr: 'Bosnie-Herzégovine', ar: 'البوسنة والهرسك',
    aliases: { en: ['bosnia', 'bosnia herzegovina', 'bih'], fr: ['bosnie', 'bosnie herzegovine'] }
  },
  'Bulgaria': { en: 'Bulgaria', fr: 'Bulgarie', ar: 'بلغاريا' },
  'Croatia': { en: 'Croatia', fr: 'Croatie', ar: 'كرواتيا' },
  'Cyprus': { en: 'Cyprus', fr: 'Chypre', ar: 'قبرص' },
  'Czechia': { 
    en: 'Czechia', fr: 'Tchéquie', ar: 'التشيك',
    aliases: { en: ['czech republic', 'czech'], fr: ['republique tcheque', 'tcheque', 'tchequie'] }
  },
  ...
  'North Macedonia': { 
    en: 'North Macedonia', fr: 'Macédoine du Nord', ar: 'مقدونيا الشمالية',
    aliases: { en: ['macedonia', 'n macedonia', 'fyrom'], fr: ['macedoine', 'macedoine du nord'] }
  },
  ...
  'Russia': { 
    en: 'Russia', fr: 'Russie', ar: 'روسيا',
    aliases: { en: ['russian federation'] }
  },
  ...
  'United Kingdom': { 
    en: 'United Kingdom', fr: 'Royaume-Uni', ar: 'المملكة المتحدة',
    aliases: { en: ['uk', 'u.k.', 'great britain', 'britain', 'england', 'gb'], fr: ['royaume uni', 'angleterre', 'grande bretagne'] }
  },
  'Vatican City': { 
    en: 'Vatican City', fr: 'Vatican', ar: 'الفاتيكان',
    aliases: { en: ['vatican', 'holy see'] }
  },
  ...
  'Laos': { 
    ...
    aliases: { en: ['lao', 'lao pdr', "lao people's democratic republic"] }
  },
  ...
  'South Korea': { 
    en: 'South Korea', fr: 'Corée du Sud', ar: 'كوريا الجنوبية',
    aliases: { en: ['s korea', 'korea', 'republic of korea', 'rok'], fr: ['coree du sud', 'coree'] }
  },
  ...
  'Taiwan': { 
    ...
    aliases: { en: ['republic of china', 'roc', 'chinese taipei'], fr: ['taiwan'] }
  },
  'Tajikistan': { en: 'Tajikistan', fr: 'Tadjikistan', ar: 'طاجيكستان' },
  'Thailand': { en: 'Thailand', fr: 'Thaïlande', ar: 'تايلاند', aliases: { fr: ['thailande'] } },
  'Timor-Leste': { 
    en: 'Timor-Leste', fr: 'Timor oriental', ar: 'تيمور الشرقية',
    aliases: { en: ['east timor', 'timor'], fr: ['timor leste', 'timor-leste'] }
  },
  ...
  // === NORTH AMERICA ===
  'Antigua and Barbuda': { 
    en: 'Antigua and Barbuda', fr: 'Antigua-et-Barbuda', ar: 'أنتيغوا وباربودا',
    aliases: { en: ['antigua'] }
  },
  'Bahamas': { 
    en: 'Bahamas', fr: 'Bahamas', ar: 'الباهاما',
    aliases: { en: ['the bahamas'] }
  },
  ...
  'Dominican Republic': { 
    en: 'Dominican Republic', fr: 'République Dominicaine', ar: 'جمهورية الدومينيكان',
    aliases: { en: ['dominican rep', 'dr'], fr: ['republique dominicaine'] }
  },
  ...
  'Puerto Rico': { 
    en: 'Puerto Rico', fr: 'Porto Rico', ar: 'بورتوريكو',
    aliases: { en: ['pr'] }
  },
  'Saint Kitts and Nevis': { 
    en: 'Saint Kitts and Nevis', fr: 'Saint-Kitts-et-Nevis', ar: 'سانت كيتس ونيفيس',
    aliases: { en: ['st kitts', 'st. kitts'] }
  },
  'Saint Lucia': { 
    en: 'Saint Lucia', fr: 'Sainte-Lucie', ar: 'سانت لوسيا',
    aliases: { en: ['st lucia', 'st. lucia'] }
  },
  'Saint Vincent and the Grenadines': { 
    en: 'Saint Vincent and the Grenadines', fr: 'Saint-Vincent-et-les-Grenadines', ar: 'سانت فنسنت والغرينادين',
    aliases: { en: ['st vincent', 'st. vincent'] }
  },
  'Trinidad and Tobago': { 
    en: 'Trinidad and Tobago', fr: 'Trinité-et-Tobago', ar: 'ترينيداد وتوباغو',
    aliases: { en: ['trinidad', 't&t'] }
  },
  'United States': { 
    en: 'United States', fr: 'États-Unis', ar: 'الولايات المتحدة',
    aliases: { en: ['usa', 'u.s.a.', 'us', 'u.s.', 'america', 'united states of america'], fr: ['etats-unis', 'etats unis', 'amerique'] }
  },
  ...
  'U.S. Virgin Islands': { 
    en: 'U.S. Virgin Islands', fr: 'Îles Vierges américaines', ar: 'جزر العذراء الأمريكية',
    aliases: { en: ['us virgin islands', 'usvi', 'american virgin islands'], fr: ['iles vierges americaines'] }
  },
  'British Virgin Islands': { 
    en: 'British Virgin Islands', fr: 'Îles Vierges britanniques', ar: 'جزر العذراء البريطانية',
    aliases: { en: ['bvi'], fr: ['iles vierges britanniques'] }
  },
  ...
  'French Guiana': { 
    en: 'French Guiana', fr: 'Guyane française', ar: 'غويانا الفرنسية',
    aliases: { en: ['guyane'], fr: ['guyane', 'guyane francaise'] }
  },
  ...
  'Falkland Islands': { 
    en: 'Falkland Islands', fr: 'Îles Malouines', ar: 'جزر فوكلاند',
    aliases: { en: ['falklands', 'malvinas', 'islas malvinas'], fr: ['malouines', 'iles malouines'] }
  },
  ...
  'Micronesia': { 
    en: 'Micronesia', fr: 'Micronésie', ar: 'ميكرونيزيا',
    aliases: { en: ['federated states of micronesia', 'fsm'], fr: ['micronesie'] }
  },
  'Nauru': { en: 'Nauru', fr: 'Nauru', ar: 'ناورو' },
  'New Zealand': { 
    en: 'New Zealand', fr: 'Nouvelle-Zélande', ar: 'نيوزيلندا',
    aliases: { en: ['nz', 'aotearoa'], fr: ['nouvelle zelande'] }
  },
  'Palau': { en: 'Palau', fr: 'Palaos', ar: 'بالاو' },
  'Papua New Guinea': { 
    en: 'Papua New Guinea', fr: 'Papouasie-Nouvelle-Guinée', ar: 'بابوا غينيا الجديدة',
    aliases: { en: ['png', 'papua'], fr: ['papouasie nouvelle guinee'] }
  },
  'Samoa': { en: 'Samoa', fr: 'Samoa', ar: 'ساموا' },
  'Solomon Islands': { 
    en: 'Solomon Islands', fr: 'Îles Salomon', ar: 'جزر سليمان',
    aliases: { en: ['solomons'], fr: ['iles salomon'] }
  },
  ...
  'French Polynesia': { 
    en: 'French Polynesia', fr: 'Polynésie française', ar: 'بولينيزيا الفرنسية',
    aliases: { en: ['tahiti'], fr: ['polynesie francaise', 'tahiti'] }
  },
  ...
  'Northern Mariana Islands': { 
    en: 'Northern Mariana Islands', fr: 'Îles Mariannes du Nord', ar: 'جزر ماريانا الشمالية',
    aliases: { en: ['northern marianas', 'cnmi'], fr: ['iles mariannes du nord', 'mariannes'] }
  },
...
const buildLookupMaps = () => {
  ...
  Object.entries(localizedCountryNames).forEach(([canonicalName, localized]) => {
    // Add the main name for each language
    (['en', 'fr', 'ar'] as Language[]).forEach(lang => {
      const name = localized[lang];
      if (name) {
        maps[lang][normalizeForMatch(name)] = canonicalName;
      }
      
      // Add aliases for this language
      const aliases = localized.aliases?.[lang] || [];
      aliases.forEach(alias => {
        maps[lang][normalizeForMatch(alias)] = canonicalName;
      });
    });
  });
...
/**
 * Get the localized name of a country for display.
 * @param canonicalName The English canonical name
 * @param language The target language
 */
export const getLocalizedCountryName = (canonicalName: string, language: Language): string => {
  return localizedCountryNames[canonicalName]?.[language] || canonicalName;
};

/**
 * Match user input to a canonical country name.
 * Returns the canonical English name if found, null otherwise.
 * @param input The user's input string
 * @param language The current language for matching
 */
export const matchCountryInput = (input: string, language: Language): string | null => {
  ...
  if (language !== 'en' && countryLookupMaps.en[normalized]) {
    return countryLookupMaps.en[normalized];
  }
  
  // Try all languages as last resort
  for (const lang of ['en', 'fr', 'ar'] as Language[]) {
    if (countryLookupMaps[lang][normalized]) {
      return countryLookupMaps[lang][normalized];
    }
  }
...
/**
 * Check if user input is a correct guess for a target country.
 * @param input The user's guess
 * @param targetCountry The canonical name of the target country
 * @param language The current language
 */
export const isCorrectGuess = (input: string, targetCountry: string, language: Language): boolean => {
  const matchedCountry = matchCountryInput(input, language);
  return matchedCountry === targetCountry;
};

/**
 * Check if user input is "close" to the target (for partial points).
 * Currently checks if input is close but not exact match.
 */
export const isCloseGuess = (input: string, targetCountry: string, language: Language): boolean => {
  ...
  // Check if input is a substring of target or vice versa (at least 4 chars)
  if (normalizedInput.length >= 4 && targetName.length >= 4) {
    if (targetName.includes(normalizedInput) || normalizedInput.includes(targetName)) {
      return true;
    }
  }
  
  // Simple Levenshtein distance check for typos (allow 1-2 character errors for longer names)
...
/**
 * Get all country names for a given language (for autocomplete, etc.)
 */
export const getAllCountryNames = (language: Language): string[] => {
  return Object.values(localizedCountryNames).map(loc => loc[language] || loc.en);
};
